...
//Pick and episode to log in the terminal
//Using dot notation, walk through the netflix object and print off both the episode number and the episode name
console.log('Episode #' + netflix.season1.seasonInfo.episodeInfo[7].episode + ': ' + netflix.season1.seasonInfo.episodeInfo[7].episodeName);
...
//Object.keys(garden) is an array, forEach is using the array, "key" is keys in the garden object, "key == g" console.log will only run if the key equals 'water'
