...
//Undefined
/*
Undefined usually means variable has been declared, but it's not been assigned a value
*/
...
//Strings
//A string is any value within quotes; JA spits out the value within the quotes
...
let third = 1050 + '100'; //treats num as string, type coercion
console.log(third);
...
Denoted by []
Has values ('blue', 'gree', 'yellos'), separated by commas
*/
